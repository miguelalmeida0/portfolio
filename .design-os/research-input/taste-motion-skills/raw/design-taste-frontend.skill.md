...
Last resort: tell the user. If neither is possible, do NOT fill the page with hand-rolled SVG illustrations or div-based "fake screenshots." Instead, leave clearly-labeled placeholder slots (<!-- TODO: hero product photo, 1600x1200 -->) and at the end of the response say: "This page needs real images at: [list of placements]. Please generate or provide them."
...
Motion layer - add MOTION_INTENSITY-appropriate micro-interactions to existing components.
Hero & key-section recomposition - restructure top-of-funnel using Section 10 vocabulary.
...
Mobile fallback - explicit collapse rules for < 768px.
Motion variants - one variant per MOTION_INTENSITY band (1-3, 4-7, 8-10). Reduced-motion fallback explicit.
Dark-mode notes - token strategy specific to this block.

...
When Miguel Design OS is embedded as `.design-os`:

```sh
node .design-os/tools/design-os.mjs new-done-report
```
...
```sh
node .design-os/tools/design-os.mjs validate-done-report done-report.local.json
```

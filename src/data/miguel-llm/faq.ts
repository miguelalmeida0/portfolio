export const faqKnowledge = [
  ...
  {
    id: 'faq-design-systems-fit',
    title: 'Design systems fit',
    source: 'CV / Approach',
    tags: ['faq', 'design systems', 'fit'],
    content:
      'Miguel is a credible fit for roles that mix frontend engineering with design-system care: reusable UI, shared frontend patterns, accessibility, UI consistency, and design collaboration.'
  },
  {
    id: 'faq-gaps',
    title: 'Known gaps',
    source: 'Boundary',
    tags: ['faq', 'gaps', 'unknown'],
    content:
      'The approved current growth area is calling things done at the right moment. Miguel cares a lot, and when he enjoys a task, he can keep polishing it longer than planned. Do not invent unrelated gaps.'
  }
] as const;

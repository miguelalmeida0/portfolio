...
Do not use large vague background blobs, ghost ellipses, generic radial glows, random translucent ovals, fake lens shapes, or abstract atmosphere shapes unless they are:

- the primary product object
- part of the selected signature interaction
- directly derived from an approved reference mechanic
- explicitly named in the shape inventory with role, layer, and purpose

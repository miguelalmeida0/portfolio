...
- `docs/internal/design-system/tools/design-os.mjs` appears in README embedded usage. It is not a missing repo file; it is the expected path after embedding this repo as `docs/internal/design-system`.
